...
public class MetalShield extends CustomRelic {
  ...
  public MetalShield() {
    super("MetalShield", ImageMaster.loadImage("img/relics/MetalShield.png"), ImageMaster.loadImage("img/relics/outline/MetalShield.png"), AbstractRelic.RelicTier.STARTER, AbstractRelic.LandingSound.CLINK);
    this.Rclick = false;
  ...
  public void onUnequip() {
    ...
    AbstractPotion p1 = AbstractDungeon.player.potions.remove(AbstractDungeon.player.potionSlots - 1);
    AbstractPotion p2 = AbstractDungeon.player.potions.remove(AbstractDungeon.player.potionSlots - 2);
    AbstractDungeon.player.potionSlots -= 2;
    if (p1 != null) {
  ...
  public void onRightClick() {
    ...
    if (this.counter > 5 && (AbstractDungeon.getCurrRoom()).phase == AbstractRoom.RoomPhase.COMBAT) {
      flash();
      addToBot((AbstractGameAction)new ApplyPowerAction((AbstractCreature)p, (AbstractCreature)p, (AbstractPower)new ZeroEnergePower((AbstractCreature)p), 1));
      this.counter -= 6;
    } 
  }
