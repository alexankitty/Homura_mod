...
public class SoulGem_Demon extends CustomRelic {
  ...
  public SoulGem_Demon() {
    super(
      "SoulGem_Demon",
      ImageMaster.loadImage("img/relics/SoulGem_Demon.png"),
      ImageMaster.loadImage("img/relics/outline/SoulGem_Demon.png"),
  ...
  private static final String IMG_OTL = "img/relics/outline/SoulGem_Demon.png";
