...
public class DetonateAction extends AbstractGameAction {
  ...
  public static final String[] TEXT =
    (CardCrawlGame.languagePack.getUIString("WishAction")).TEXT;
          ...
          if ("The Bomb".equals(c.cardID)) {
            addToBot(
              (AbstractGameAction) new DamageAllEnemiesAction(
                null,
                DamageInfo.createDamageMatrix(c.magicNumber, true),
            ...
            addToBot(
              (AbstractGameAction) new NewQueueCardAction(c, true, false, true)
            );
          }
