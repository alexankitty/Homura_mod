...
public class Feeding extends CustomCard {
  private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("Feeding"); public static final String ID = "Feeding";
  ...
  public Feeding() {
    super("Feeding", NAME, "img/cards/Feeding_skill.png", 1, DESCRIPTION, AbstractCard.CardType.SKILL, AbstractCardEnum.Homura_COLOR, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.SELF);
  }
