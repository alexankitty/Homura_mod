...
public class DesertEagle extends CustomCard {
  private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("DesertEagle"); public static final String ID = "DesertEagle";
  ...
  public DesertEagle() {
    super("DesertEagle", NAME, "img/cards/DesertEagle_attack.png", 1, DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCardEnum.Homura_COLOR, AbstractCard.CardRarity.COMMON, AbstractCard.CardTarget.ENEMY);
    this.baseDamage = 5;
