...
public class ThePriceOfMiracles extends CustomCard {
  private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("ThePriceOfMiracles"); public static final String ID = "ThePriceOfMiracles";
  ...
  public ThePriceOfMiracles() {
    super("ThePriceOfMiracles", NAME, "img/cards/ThePriceOfMiracles_skill.png", 0, DESCRIPTION, AbstractCard.CardType.SKILL, AbstractCardEnum.Homura_COLOR, AbstractCard.CardRarity.COMMON, AbstractCard.CardTarget.ALL_ENEMY);
  ...
  public void use(AbstractPlayer p, AbstractMonster m) {
    addToBot((AbstractGameAction)new MakeTempCardInHandAction((AbstractCard)new Miracle(), this.magicNumber));
