...
public class Witch extends CustomCard {
  private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("Witch"); public static final String ID = "Witch";
  ...
  public Witch() {
    super("Witch", NAME, "img/cards/Witch_power.png", 1, DESCRIPTION, AbstractCard.CardType.POWER, AbstractCardEnum.Homura_COLOR, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.NONE);
