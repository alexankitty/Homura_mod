...
public class No8 extends CustomCard {
  private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("No8"); public static final String ID = "No8";
  ...
  public No8() {
    super("No8", NAME, "img/cards/No8_attack.png", 1, DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCardEnum.Homura_COLOR, AbstractCard.CardRarity.COMMON, AbstractCard.CardTarget.NONE);
    this.baseDamage = 9;
