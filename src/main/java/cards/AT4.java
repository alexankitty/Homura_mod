...
public class AT4 extends CustomCard {
  private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("AT4"); public static final String ID = "AT4";
  ...
  public AT4() {
    super("AT4", NAME, "img/cards/AT4_attack.png", 1, DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCardEnum.Homura_COLOR, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.ENEMY);
    this.baseDamage = 12;
    this.exhaust = true;
  }
