...
public class LawOfCycles extends CustomCard {
  ...
  private static final CardStrings cardStrings =
    CardCrawlGame.languagePack.getCardStrings("LawOfCycles");
  public static final String ID = "LawOfCycles";
  ...
  public LawOfCycles() {
    super(
      "LawOfCycles",
      NAME,
      "img/cards/LawOfCycles_power.png",
      3,
      DESCRIPTION,
  ...
  public void use(AbstractPlayer p, AbstractMonster m) {
    addToBot(
      (AbstractGameAction) new ApplyPowerAction(
        (AbstractCreature) p,
        (AbstractCreature) p,
        (AbstractPower) new LawOfCyclesPower((AbstractCreature) p, 1)
      )
    );
  }
