...
public class No15 extends CustomCard {
  private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("No15"); public static final String ID = "No15";
  ...
  public No15() {
    super("No15", NAME, "img/cards/No15_skill.png", -2, DESCRIPTION, AbstractCard.CardType.SKILL, AbstractCardEnum.Homura_COLOR, AbstractCard.CardRarity.RARE, AbstractCard.CardTarget.SELF);
