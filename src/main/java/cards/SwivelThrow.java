...
public class SwivelThrow extends CustomCard {
  private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("SwivelThrow"); public static final String ID = "SwivelThrow";
  ...
  public SwivelThrow() {
    super("SwivelThrow", NAME, "img/cards/SwivelThrow_skill.png", 2, DESCRIPTION, AbstractCard.CardType.SKILL, AbstractCardEnum.Homura_COLOR, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.SELF);
    this.baseBlock = 8;
  }
