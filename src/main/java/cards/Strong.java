...
public class Strong extends CustomCard {
  private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("Strong"); public static final String ID = "Strong";
  ...
  public Strong() {
    super("Strong", NAME, "img/cards/Strong_power.png", 1, DESCRIPTION, AbstractCard.CardType.POWER, AbstractCardEnum.Homura_COLOR, AbstractCard.CardRarity.RARE, AbstractCard.CardTarget.SELF);
