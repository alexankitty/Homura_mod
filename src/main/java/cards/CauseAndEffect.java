...
public class CauseAndEffect extends CustomCard {
  private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("CauseAndEffect"); public static final String ID = "CauseAndEffect";
  ...
  public CauseAndEffect() {
    super("CauseAndEffect", NAME, "img/cards/CauseAndEffect.png", -2, DESCRIPTION, AbstractCard.CardType.CURSE, AbstractCard.CardColor.CURSE, AbstractCard.CardRarity.SPECIAL, AbstractCard.CardTarget.NONE);
  ...
  public static void loadGame() {
    ...
    AbstractDungeon.player.masterDeck.group.stream().filter(c -> c instanceof CauseAndEffect).forEach(CauseAndEffect::load);
  }
  ...
  public void onRemoveFromMasterDeck() {
    AbstractDungeon.effectsQueue.add(new NecronomicurseEffect((AbstractCard)new CauseAndEffect(), Settings.WIDTH / 2.0F, Settings.HEIGHT / 2.0F));
