...
public class Prepare extends CustomCard {
  private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("Prepare"); public static final String ID = "Prepare";
  ...
  public Prepare() {
    super("Prepare", NAME, "img/cards/Prepare_skill.png", 0, DESCRIPTION, AbstractCard.CardType.SKILL, AbstractCardEnum.Homura_COLOR, AbstractCard.CardRarity.COMMON, AbstractCard.CardTarget.SELF);
