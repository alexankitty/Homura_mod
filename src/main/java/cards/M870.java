...
public class M870 extends CustomCard {
  ...
  private static final CardStrings cardStrings =
    CardCrawlGame.languagePack.getCardStrings("M870");
    ...
    for (int i = 0; i < this.magicNumber; i++) {
      ...
      addToBot(
        (AbstractGameAction) new ApplyPowerAction(
          (AbstractCreature) m,
          (AbstractCreature) p,
          (AbstractPower) new WeakPower((AbstractCreature) m, 1, false),
          1,
          true,
      ...
      addToBot(
        (AbstractGameAction) new ApplyPowerAction(
          (AbstractCreature) m,
          (AbstractCreature) p,
          (AbstractPower) new VulnerablePower((AbstractCreature) m, 1, false),
          1,
          true,
          AbstractGameAction.AttackEffect.NONE
        )
