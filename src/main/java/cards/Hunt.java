...
public class Hunt extends CustomCard {
  private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("Hunt"); public static final String ID = "Hunt";
  ...
  public Hunt() {
    super("Hunt", NAME, "img/cards/Hunt_attack.png", 1, DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCardEnum.Homura_COLOR, AbstractCard.CardRarity.COMMON, AbstractCard.CardTarget.ENEMY);
    this.baseDamage = 8;
