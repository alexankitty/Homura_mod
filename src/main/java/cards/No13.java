...
public class No13 extends CustomCard {
  private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("No13"); public static final String ID = "No13";
  ...
  public No13() {
    super("No13", NAME, "img/cards/No13_skill.png", 1, DESCRIPTION, AbstractCard.CardType.SKILL, AbstractCardEnum.Homura_COLOR, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.SELF);
  ...
  public void use(AbstractPlayer p, AbstractMonster m) {
    ...
    addToBot((AbstractGameAction)new MakeTempCardInDiscardAction((new Normality()).makeCopy(), 1));
  }
