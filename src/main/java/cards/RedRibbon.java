...
public class RedRibbon extends CustomCard {
  private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("RedRibbon"); public static final String ID = "RedRibbon";
  ...
  public RedRibbon() {
    super("RedRibbon", NAME, "img/cards/RedRibbon_power.png", 0, DESCRIPTION, AbstractCard.CardType.POWER, AbstractCardEnum.Homura_COLOR, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.SELF);
