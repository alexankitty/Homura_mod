...
public class MagicLongbow extends CustomCard {
  private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("MagicLongbow"); public static final String ID = "MagicLongbow";
  ...
  public MagicLongbow() {
    super("MagicLongbow", NAME, "img/cards/MagicLongbow_attack.png", 1, DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCardEnum.Homura_COLOR, AbstractCard.CardRarity.RARE, AbstractCard.CardTarget.ENEMY);
    this.baseDamage = 14;
