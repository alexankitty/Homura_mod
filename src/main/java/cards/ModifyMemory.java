...
public class ModifyMemory extends CustomCard {
  ...
  private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("ModifyMemory");
  ...
  public ModifyMemory() {
    super("ModifyMemory", NAME, "img/cards/ModifyMemory_skill.png", 1, DESCRIPTION, AbstractCard.CardType.SKILL, AbstractCardEnum.Homura_COLOR, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.ENEMY);
