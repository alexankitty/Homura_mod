...
public class SSM1 extends CustomCard {
  ...
  private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("SSM1");
  ...
  public SSM1() {
    super("SSM1", NAME, "img/cards/SSM1_attack.png", 3, DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCardEnum.Homura_COLOR, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.ALL_ENEMY);
    this.baseDamage = 4;
    this.exhaust = true;
  }
