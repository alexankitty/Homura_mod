...
public class M18A1 extends CustomCard {

  public static final String ID = "M18A1";
  private static final CardStrings cardStrings =
    CardCrawlGame.languagePack.getCardStrings("M18A1");
  ...
  public void use(AbstractPlayer p, AbstractMonster m) {
    addToBot(
      (AbstractGameAction) new ApplyPowerAction(
        (AbstractCreature) p,
        (AbstractCreature) p,
        (AbstractPower) new M18A1Power((AbstractCreature) p, this.magicNumber),
        this.magicNumber
      )
    );
  }
