...
public class DodgeShot extends CustomCard {
  private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("DodgeShot"); public static final String ID = "DodgeShot";
  ...
  public DodgeShot() {
    super("DodgeShot", NAME, "img/cards/DodgeShot_attack.png", 1, DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCardEnum.Homura_COLOR, AbstractCard.CardRarity.COMMON, AbstractCard.CardTarget.ENEMY);
    this.baseBlock = 5;
    this.baseDamage = 5;
  ...
  public void use(AbstractPlayer p, AbstractMonster m) {
    ...
    addToTop((AbstractGameAction)new GainBlockAction((AbstractCreature)p, (AbstractCreature)p, this.block));
  }
