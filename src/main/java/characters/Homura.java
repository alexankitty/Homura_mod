...
public class Homura extends CustomPlayer {
  ...
  private static final String[] ORB_TEXTURES = new String[] { "img/UI/layer/border.png", "img/UI/layer/l1.png", "img/UI/layer/l2.png", "img/UI/layer/l3.png", "img/UI/layer/l4.png" };
  ...
  public Homura(String name) {
    super(name, EgomodClassEnum.Homura_CLASS, ORB_TEXTURES, "img/UI/energyPurpleVFX.png", null, null, null);
    ...
    initializeClass(STAND, "img/char/Homura_shoulder.png", "img/char/Homura_shoulder.png", "img/char/Homura_fallen.png", 
        getLoadout(), 20.0F, 0.0F, 220.0F, 290.0F, new EnergyManager(3));
  ...
  public CharSelectInfo getLoadout() {
    ...
    { case ZHT:
      case ZHS:
        title = "晓美焰";
        flavor = "外表秀丽，说的话总是意向不明的魔法少女。 NL 不具备攻击性的魔法，装备各式军火战斗。";
  ...
  public String getTitle(AbstractPlayer.PlayerClass playerClass) {
    ...
    { case ZHT:
      case ZHS:
        ...
        return title;case RUS: title = "Хомура"; return title;case KOR: title = "마법소녀"; return title; }  title = "the Magical Girl"; return title;
  }
  ...
  public String getLocalizedCharacterName() {
    ...
    { case ZHT:
      case ZHS:
        ...
        return char_name;case RUS: char_name = "Акеми Хомура"; return char_name;case KOR: char_name = "아케미 호무라"; return char_name; }  char_name = "Akemi Homura"; return char_name;
  }
