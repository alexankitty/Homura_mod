...
public class BombMakingUpPower extends AbstractPower {
  private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings("BombMakingUpPower"); public static final String POWER_ID = "BombMakingUpPower";
