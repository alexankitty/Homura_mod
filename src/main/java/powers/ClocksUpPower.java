...
public class ClocksUpPower extends AbstractPower {
  private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings("ClocksUpPower"); public static final String POWER_ID = "ClocksUpPower";
  public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS; private int count;
  ...
  public void onUseCard(AbstractCard card, UseCardAction action) {
    ...
    if (this.amount == 12) {
      ...
      c.upgrade();
      addToBot((AbstractGameAction)new MakeTempCardInHandAction(c, this.count));
      this.amount = 0;
    } 
  }
