...
public class Patch {
  ...
  public static ArrayList<AbstractCard> getServant(int num) {
    ...
    AbstractCard[] ServantGroup = { No1, No2, No3, No4, No5, No6, No7, No8, No9, No10, No11, No12, No13, No14, No15 };
    boolean[] hasServant = countServantArr();
  ...
  public static AbstractCard[] getArmsCard() {
    ...
    AbstractCard[] ArmsGroup = { Prepare, M18A1, DesertEagle, M92, M249, M870, TheBomb, TimeBomb, IED, FlashBang, M84, Smoke, AT4, SSM1, FuelTankCar };
    return ArmsGroup;
  }
