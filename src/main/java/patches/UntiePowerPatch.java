...
/* 25 */     if (target == AbstractDungeon.player && AbstractDungeon.player.hasPower("UntiePower"))
/*    */     {
/* 27 */       if (powerToApply.ID.equals("Weakened") || powerToApply.ID.equals("Frail") || powerToApply.ID.equals("Vulnerable")) {
/* 28 */         AbstractDungeon.actionManager.addToTop((AbstractGameAction)new TextAboveCreatureAction(target, (CardCrawlGame.languagePack.getUIString("ApplyPowerAction")).TEXT[1]));
/* 29 */         duration[0] = duration[0] - Gdx.graphics.getDeltaTime();
/*    */       } 
/*    */     }
/*    */     
/* 33 */     return SpireReturn.Continue();
/*    */   }
/*    */ }
