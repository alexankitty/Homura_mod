...
public class HomuraMod implements AddAudioSubscriber, StartGameSubscriber, RelicGetSubscriber, PostPowerApplySubscriber, PostExhaustSubscriber, PostBattleSubscriber, PostDungeonInitializeSubscriber, PostDrawSubscriber, PostEnergyRechargeSubscriber, PostInitializeSubscriber, EditCharactersSubscriber, EditRelicsSubscriber, EditCardsSubscriber, EditKeywordsSubscriber, EditStringsSubscriber, OnCardUseSubscriber, OnPowersModifiedSubscriber {
  ...
  public HomuraMod() {
    ...
    BaseMod.addColor(AbstractCardEnum.Homura_COLOR, PurpleBlack, PurpleBlack, PurpleBlack, PurpleBlack, PurpleBlack, PurpleBlack, PurpleBlack, "img/512/Homura_attack.png", "img/512/Homura_skill.png", "img/512/Homura_power.png", "img/512/Homura_card_purple_orb.png", "img/1024/Homura_attack.png", "img/1024/Homura_skill.png", "img/1024/Homura_power.png", "img/1024/Homura_cardOrb.png", "img/UI/Homura_energyOrb.png");
    try {
      if (config == null) {
  ...
  public void receivePostInitialize() {
    ...
    BaseMod.addPotion(GriefSeed.class, Color.BLACK.cpy(), Color.BLACK.cpy(), null, "GriefSeed");
    
    Texture badgeTexture = new Texture("img/char/Homura_Badge.png");
    ModPanel settingsPanel = new ModPanel();
    BaseMod.registerModBadge(badgeTexture, "Akemi_Homura", "EGOIST", "", settingsPanel);
    ...
    ModLabeledToggleButton setSchoolUniform = new ModLabeledToggleButton(labelText1, 350.0F, 750.0F, Settings.CREAM_COLOR, FontHelper.charDescFont, isSchoolUniform, settingsPanel, label -> {
    ...
    ModLabeledToggleButton setMagicalGirl = new ModLabeledToggleButton(labelText2, 350.0F, 700.0F, Settings.CREAM_COLOR, FontHelper.charDescFont, isMagicalGirl, settingsPanel, label -> {
  ...
  public void receiveEditCharacters() {
    BaseMod.addCharacter((AbstractPlayer)new Homura("Akemi_Homura"), "img/charSelect/Homura_Button.png", "img/charSelect/Homura_Portrait.png", EgomodClassEnum.Homura_CLASS);
  }
  ...
  public void receiveEditStrings() {
    ...
    String scoreStrings = Gdx.files.internal(score_bonuse).readString(String.valueOf(StandardCharsets.UTF_8));
  ...
  public void receiveEditRelics() {
    BaseMod.addRelicToCustomPool((AbstractRelic)new MetalShield(), AbstractCardEnum.Homura_COLOR);
    BaseMod.addRelicToCustomPool((AbstractRelic)new Mami(), AbstractCardEnum.Homura_COLOR);
    BaseMod.addRelicToCustomPool((AbstractRelic)new BlackLongbow(), AbstractCardEnum.Homura_COLOR);
    BaseMod.addRelicToCustomPool((AbstractRelic)new SoulGem_Demon(), AbstractCardEnum.Homura_COLOR);
  }
