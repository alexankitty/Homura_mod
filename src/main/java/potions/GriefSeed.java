...
public class GriefSeed extends AbstractPotion {
  ...
  private static final PotionStrings potionStrings = CardCrawlGame.languagePack.getPotionString("GriefSeed");
  public GriefSeed() {
    super(potionStrings.NAME, "GriefSeed", AbstractPotion.PotionRarity.COMMON, AbstractPotion.PotionSize.FAIRY, AbstractPotion.PotionColor.SMOKE);
    this.labOutlineColor = HomuraMod.PurpleBlack;
    ReflectionHacks.setPrivate(this, AbstractPotion.class, "containerImg", PhotoTexture.getTexture("img/potions/GriefSeed.png"));
    ReflectionHacks.setPrivate(this, AbstractPotion.class, "liquidImg", PhotoTexture.getTexture("img/potions/GriefSeed.png"));
    ReflectionHacks.setPrivate(this, AbstractPotion.class, "hybridImg", PhotoTexture.getTexture("img/potions/GriefSeed.png"));
    ReflectionHacks.setPrivate(this, AbstractPotion.class, "spotsImg", PhotoTexture.getTexture("img/potions/GriefSeed.png"));
    ReflectionHacks.setPrivate(this, AbstractPotion.class, "outlineImg", PhotoTexture.getTexture("img/potions/GriefSeed.png"));
